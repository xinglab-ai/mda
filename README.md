...
```python
# All trained models used in our experiments, including those for the super-resolution task, segmentation task, gene expression prediction task, survival prediction task, and classification task, have been uploaded to the provided data drive link. Here, we provide an example of the feature extraction process for the segmentation task.
```
